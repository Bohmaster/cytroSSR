...
class PropDetalle extends React.Component {
  ...
  static getInitialData({ req, res, match }) {
    return new Promise((resolve, reject) => {
      ...
      axios.get('http://localhost:3005/api/Propiedads/' + propId, {
        params: {
          include: 'contacto'
        }
      })
        .then(prop => {
          ...
          axios.get('http://localhost:3005/api/Contactos/' + prop.data.contactoId)
            .then(ctc => {
  ...
  getTheFuckingPhotos() {
    ...
    for (let i = 0; i < 6; i++) {
      if (this.props.propiedad['foto_' + (i+1)]) {
        ...
        if (i === 0) {
          array.push('http://localhost:3005/api/containers/thumbs/download/' + this.props.propiedad['foto_' + (i+1)])
        } else {
          array.push('http://localhost:3005/api/containers/images/download/' + this.props.propiedad['foto_' + (i+1)])
        }
      } else {
  ...
  render() {
    ...
    return (
      <div className="section-3">
        <div className="div-block-6" style={{ backgroundImage: "url(" + 'http://localhost:3005/api/containers/thumbs/download/' + propiedad['foto_1'] + ")" }}>
          ...
          <div className="row w-row">
            <div className="column-6 w-col w-col-9">
              ...
              <div className="descripcionpropiedad">
                ...
                <img src={'http://localhost:3005/api/containers/thumbs/download/' + propiedad['foto_1']} sizes="(max-width: 479px) 99vw, (max-width: 767px) 98vw, (max-width: 991px) 72vw, 64vw" className="image-6" />
